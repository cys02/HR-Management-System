...
export default {
  methods:{
    ...
    search() {
      if(this.$refs.optionRef.selected.value==="1"){
        ...
        console.log(myData)
        const _this = this
        axios.post('http://localhost:9091/getManagerSalaryById',myData).then(function (resp) {
        ...
        console.log(myData)
        const _this = this
        axios.post('http://localhost:9091/getManagerSalaryByName',myData).then(function (resp) {
          _this.tableData = resp.data;
        })
      }
    }
  ...
  created() {
    var _this = this
    axios.get('http://localhost:9091/getManagerSalary').then(function(resp){
      _this.tableData = resp.data;
    })
  },
  data() {
